...
| Type          | Effect | Notes                                                                                                        |
| ------------- | ------ | ------------------------------------------------------------------------------------------------------------ |
| **Blunt**     | WHP    | 2× DMG vs Solid (tough) (Rock Golem); 0.5× vs Squishy (Slime). Can knock prone on nat 20.                     |
| **Piercing**  | CHP    | 2× DMG vs Meaty/Squishy (Humans). Half damage hits WHP and half hits CHP; on attack roll >15 all damage to CHP; nat 20 = all damage to CHP. |
| **Slashing**  | WHP    | Applies bleeding on attack rolls >15 (requires an action to stop bleeding).                                  |
| **Acid**      |        |                                                                                                              |
| **Fire**      |        |                                                                                                              |
| **Cold**      |        |                                                                                                              |
| **Lightning** |        |                                                                                                              |
